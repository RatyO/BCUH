...
This tutorial illustrates the use of R package BCUH in which several bias correction and delta change methods have been implemented based on Räisänen and Räty (2013), Räty et al. (2014). In addition, a copula-based joint bias correction method designed for temperature and precipitation is available. The implementation of the copula-based algorithm is partially based on Li et al (2014) and Gennaretti et al. (2015) and has further been applied by Räty el et. (submitted).

#Structure

All the statistical methods implemented in BCUH have been coded as S4 methods belonging to a set of classes. The most important ones are the 
